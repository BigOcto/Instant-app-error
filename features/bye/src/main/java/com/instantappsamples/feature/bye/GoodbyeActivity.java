...
public class GoodbyeActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Log.e("getResource","layout getResource result id : " + id + ", R.layout result: " + R.layout.activity_goodbye);
...
//    setContentView(id);
    ...
    Log.e("getResource","textView getResource result id : " + goodbye_text2_id + " , R.id result ：" + R.id.goodbye_text2);
